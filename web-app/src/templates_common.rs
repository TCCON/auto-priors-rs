...
pub(crate) fn sblink_inner(root_uri: &str, resource_uri: &str, text: &str, curr_page_id: &str, link_page_id: &str) -> Sblink {
    ...
    let url = format!("{}/{}", root_uri.trim_end_matches("/"), resource_uri.trim_start_matches("/"));
    ...
    Sblink { classes, url, text: text.to_string() }
}